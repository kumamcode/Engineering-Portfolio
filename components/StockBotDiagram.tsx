...
export default function StockBotDiagram() {
  return (
    <div className="w-full p-4 min-w-0">
      <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-6 text-center">System Architecture</h3>
      ...
      <div className="flex flex-nowrap items-start justify-center gap-4 pb-4 overflow-x-auto">
        ...
        <div className="flex flex-col items-center gap-2 flex-shrink-0">
          <h4 className="text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1">Data Collection</h4>
        ...
        <div className="flex flex-col items-center gap-2 flex-shrink-0">
          <h4 className="text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1">AI Processing</h4>
          <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col items-center gap-2 flex-shrink-0">
          <h4 className="text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1">Validation</h4>
          <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col items-center gap-2 flex-shrink-0">
          <h4 className="text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1">Output</h4>
          <div className="flex flex-col gap-2">
      ...
      <div className="mt-8 pt-6 border-t border-gray-200 dark:border-neutral-700">
        <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 text-center">Additional Features</h4>
        <div className="flex flex-wrap justify-center gap-2">
          <span className="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-3 py-1 rounded-full text-xs">Failed Ticker Caching</span>
          <span className="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-3 py-1 rounded-full text-xs">Rate Limiting</span>
          <span className="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-3 py-1 rounded-full text-xs">macOS Automation</span>
          <span className="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-3 py-1 rounded-full text-xs">Error Handling</span>
        </div>
      </div>
    </div>
  );
